...
*HP
use "$project/2014 & 2015 completenetss/data for analysis (2015)/health posts 2015.dta", clear
drop region facility_name
gen facility_type = 1
save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", replace

*HC
use "$project/2014 & 2015 completenetss/data for analysis (2015)/health centers 2015.dta", clear
drop region facility_name
gen facility_type = 2
append using "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", force
save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", replace

*Clinics
use "$project/2014 & 2015 completenetss/data for analysis (2015)/Private clinics 2015.dta", clear
drop region facility_name
gen facility_type = 3
append using "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", force
save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", replace
...
* Public H
use "$project/2014 & 2015 completenetss/data for analysis (2015)/Public hospitals 2015.dta", clear
drop region facility_name
gen facility_type = 4
append using "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", force
save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", replace
...
* Private H
use "$project/2014 & 2015 completenetss/data for analysis (2015)/Private hospitals 2015.dta", clear
drop region facility_name
gen facility_type = 5
append using "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", force
save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015.dta", replace
...
preserve 
	...
	collapse (count) Post_Contra-countDiabetes_Referred_HC, by(region period facility_type)
...
collapse (sum) Post_Contra-Diabetes_Referred_HC, by(region facility_type facid org*)
...
egen total = rowtotal(Post_Contra-Diabetes_Referred_HC) // 15,578 facilities listed
drop if total==0 // 4,884 reported none of the indicators, remaining total is 10,694 facilities
drop total

save "$project/2014 & 2015 completenetss/data for analysis (2015)/UQPC 2015 annual by facility.dta", replace
