...
*Merging with FP OPD volumes
	import delimited "$project/Data/Raw/UQPC data for private hospitals for 2015 EFY.csv", clear
	save  "$project/Data/Data for analysis/Private hospitals 2015.dta", replace
	import delimited "$project/Data/Raw/UQPC volume data for Private Hospitals.csv for 2015 EFY.csv", clear
	merge 1:1 organisationunitid  periodname using "$project/Data/Data for analysis/Private hospitals 2015.dta"
	drop _merge 
