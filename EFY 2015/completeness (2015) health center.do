...
iimport delimited "$project/DHIS2 data for utilization and quality of primary care/UQPC data for Health centers for 2015 EFY.csv", clear
...
save  "$project/Data for analysis/health centers 2015.dta", replace
*------------------------------------------------------------------------------*/
