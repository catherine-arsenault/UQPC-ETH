...
* Completeness assessment private clinics EFY 2014 (2021-22)

*------------------------------------------------------------------------------*
global project "/Users/catherine.arsenault/Dropbox/9 PAPERS & PROJECTS/UQPC/DHIS2/"
import delimited "$project/Data/Raw/UQPC data for clinics.csv for 2014 EFY.csv", clear

*global project "/Users/dessalegnsheabo/Desktop/UQPC/DHIS2"
*import delimited "$project/DHIS2 data for utilization and quality of primary care/UQPC data for clinics.csv for 2014 EFY.csv", clear
...
local varlist Post_Contra Faci_delivery ANC_first_16 ANC_first_total ANC_four_visits syphilis_tested_preg Hepat_BC_tested_preg HIV_tested_preg IFA_received_preg PNC_seven_days PNC_two_days DPT3_received DPT1_received OPV3_received OPV1_received PCV3_received PCV1_received Rota2_received Rota1_received VitaminA2_received VitaminA1_received Dewormed_second Dewormed_first malnutrition_exit malnutrition_cured ART_still ART_original viral_load_undetect viral_load_tested TB_ART_screened ART_total Hyper_raised_BP Diabet_raised_BS Hyper_enrol_care Diabet_enrol_care Diabet6_controlled Diabet6_enrol_care Hyper6_controlled Hyper6_enrol_care Drug_presc_100 FP_total OPD_total Drug_presc_received Essential_drug_avail 
foreach x of local varlist {
	replace `x'=. if `x'==0
}	

save  "$project/Data/Data for analysis/Private clinics 2014.dta", replace			
*------------------------------------------------------------------------------*/			
*completness table: Using the number of facilites that reproted at least onetime that year as denominator 
foreach x of local varlist  {
...
export excel using "$project/completeness_private clinics 2014.xlsx", sheet(Option_two) firstrow(variable) sheetreplace			
